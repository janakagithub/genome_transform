...
class genome_transform(object):
    ...
    def genbank_to_genome(self, genbank_to_genome_params, context=None):
        ...
        :param genbank_to_genome_params: instance of type
           ...
           parameter "html_link" of type "object_id" (Name of an object in
           the KBase workspace)
    ...
    def narrative_genbank_to_genome(self, narrativeGenbank_to_genome_params, context=None):
        """
        :param narrativeGenbank_to_genome_params: instance of type
           "narrativeGenbank_to_genome_params" -> structure: parameter
           "genbank_file_path" of type "file_path" (Path to a file containing
           a data file for upload on the local filesystem), parameter
           "workspace" of type "workspace_id" (Name of a KBase workspace),
           parameter "genome_id" of type "object_id" (Name of an object in
           the KBase workspace), parameter "html_link" of type "object_id"
